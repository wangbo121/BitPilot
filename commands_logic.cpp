...
/********************************************************************************/
void Copter:: process_nav_command()
{
...
void Copter:: process_cond_command()
{
...
void Copter:: process_now_command()
{
	switch(command_cond_queue.id){
...
bool Copter:: verify_loiter_turns()
{
...
void Copter:: do_within_distance()
{
...
void Copter:: do_change_speed()
{
	g.waypoint_speed_max = command_cond_queue.p1 * 100;
}

void Copter:: do_target_yaw()
{
...
void Copter:: do_loiter_at_location()
{
	next_WP = current_loc;
}
...
void Copter:: do_jump()
{
	...
	int8_t jump = -10;								// used to track loops in jump command
